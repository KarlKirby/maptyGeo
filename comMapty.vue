    ...
    methods: {
      ...
      newWorkout(e) {
        ...
        if (type === 'running') {
          ...
          workout = new Workout(coords, distance, duration, cadence, 'running');
        }
        ...
        if (type === 'cycling') {
          ...
          workout = new Workout(coords, distance, duration, elevation, 'cycling');
        }
      ...
      renderWorkout(workout) {
        this.$el.querySelector('.workouts').insertAdjacentHTML('beforeend', `
