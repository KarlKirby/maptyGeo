<template>
    <div>
      ...
      <!-- <div id="map"></div> Uncomment when ready to use Leaflet -->
    </div>
  </template>
  ...
  export default {
      ...
      return {
        workouts: [
          // Dummy data
          {
            ...
            cadence: 160,
            pace: 6,
            description: 'Running on October 31',
          },
          {
            id: '2',
            type: 'cycling',
            ...
            elevationGain: 200,
            speed: 15,
            description: 'Cycling on October 30',
          },
        ],
        workoutType: 'running',
        distance: 0,
    ...
    methods: {
      ...
      newWorkout() {
        ...
        if (type === 'running') {
          ...
          workout = {
            ...
            type: 'running',
            coords: [39, -12], // Dummy coordinates
            distance,
            duration,
            cadence,
      ...
      moveToPopup(workout) {
        // This function can be expanded later for map functionality
        alert(`Moving to ${workout.description}`);
      },
    },
  };
  </script>
